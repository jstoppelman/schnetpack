...
def triple_distances_apnet(
    ...
    offset_idx_k=None,
    cell=None,
    cell_offsets_intra=None,
    cell_offsets_inter=None,
):
    """
    ...
    if cell is not None:
        ...
        B_intra, A_intra, N_intra, D_intra = cell_offsets_intra.size()
        B_inter, A_inter, N_inter, D_inter = cell_offsets_inter.size()

        cell_offsets_intra = cell_offsets_intra.view(B_intra, A_intra * N_intra, D_intra)
        offsets_intra = cell_offsets_intra.bmm(cell)
        offsets_intra = offsets_intra.view(B_intra, A_intra, N_intra, D_intra)

        cell_offsets_inter = cell_offsets_inter.view(B_inter, A_inter * N_inter, D_inter)
        offsets_inter = cell_offsets_inter.bmm(cell)
        offsets_inter = offsets_inter.view(B_inter, A_inter, N_inter, D_inter)
        ...
        offsets_intra = offsets_intra.view(B * A, -1, D_intra)
        offsets_inter = offsets_inter.view(B * A, -1, D_inter)
        ...
        offset_j = offsets_inter[idx_offset_m, offset_idx_j[:]].view(B, A, T, D_inter)
        offset_k = offsets_intra[idx_offset_m, offset_idx_k[:]].view(B, A, T, D_intra)
