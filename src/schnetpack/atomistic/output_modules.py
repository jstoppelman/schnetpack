...
class Atomwise_mod(nn.Module):
    ...
    def __init__(
        ...
        super(Atomwise_mod, self).__init__()
    ...
    def forward(self, inputs):
        ...
        predicts atomwise property
        """
        fd = inputs["representation"][1]
        inputs["representation"] = inputs["representation"][0]
...
class Pairwise_Mod(nn.Module):
    def __init__(
        ...
        super(Pairwise_Mod, self).__init__()
        ...
        self.out_net = schnetpack.nn.blocks.PairGatedNetwork_Mod(
            n_in,
            n_out,
            elements,
            n_acsf,
    ...
    def forward(self, inputs):
        fd = inputs["representation"][-1]
        inputs["representation"] = inputs["representation"][0:-1]
